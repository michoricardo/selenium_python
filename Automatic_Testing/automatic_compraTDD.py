...
from compra_Ramos_TDDTDC import shoppingRamosTDDTDC
...
if __name__ == "__main__":
   ...
   for i in range(0,vecesnum):
      test_classes_to_run.append(shoppingRamosTDDTDC)
...
#Segunda parte del tutorial en stackoverflow
   ...
   for test_class in test_classes_to_run:
      suite = loader.loadTestsFromTestCase(shoppingRamosTDDTDC)
