...
import os
import emailLogin as el #Archivo para iniciar sesión en email

class shoppingRamosInstitucional(unittest.TestCase):
    ...
    def test_compraChicharron(self):
        ...
        print("<br>")
        time.sleep(5)
        #botón de institucional
        btn_INST = driver.find_element_by_xpath('//*[@id="b2bPaymentLi"]/a')
        if btn_INST is not None:
            print("Eligiendo metodo de pago Institucional o B2B")
            print("<br>")
            btn_INST.click()
            driver.implicitly_wait(10)
            time.sleep(8)
