...
from generalDashboard_module_test  import generalDashboardTestClass 
...
if __name__ == "__main__":
   ...
   for i in range(0,vecesnum):
      test_classes_to_run.append(generalDashboardTestClass)
...
#Segunda parte del tutorial en stackoverflow
   ...
   for test_class in test_classes_to_run:
      suite = loader.loadTestsFromTestCase(generalDashboardTestClass)
